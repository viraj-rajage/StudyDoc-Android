...
public class CProgram extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(CProgram.this, R.color.application_background));
        ...
        notesbackView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CProgram.this, Program_activity.class));
            }
        });
        ...
        not_working.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String utl="https://studydocs.netlify.app/programe_c/c";
        ...
        webview.loadUrl("https://studydocs.netlify.app/programe_c/c");
