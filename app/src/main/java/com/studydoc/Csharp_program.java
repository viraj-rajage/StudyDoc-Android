...
public class Csharp_program extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csharp_program);
        getWindow().setStatusBarColor(ContextCompat.getColor(Csharp_program.this, R.color.application_background));
        ...
        notesbackView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Csharp_program.this, Program_activity.class));
            }
        });
        ...
        not_working.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String utl="https://studydocs.netlify.app/programe_csharp/cs";
        ...
        webview.loadUrl("https://studydocs.netlify.app/programe_csharp/cs");
