...
public class python_program extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(ContextCompat.getColor(python_program.this, R.color.application_background));
        ...
        notesbackView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(python_program.this, Program_activity.class));
            }
        });
        ...
        not_working.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String utl="https://studydocs.netlify.app/programe_python/python";
        ...
        webview.loadUrl("https://studydocs.netlify.app/programe_python/python");
