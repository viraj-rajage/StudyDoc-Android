...
public class java_program extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_java_program);
        getWindow().setStatusBarColor(ContextCompat.getColor(java_program.this, R.color.application_background));
        ...
        notesbackView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(java_program.this, Program_activity.class));
            }
        });
        ...
        not_working.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String utl="https://studydocs.netlify.app/programe_java/java";
        ...
        webview.loadUrl("https://studydocs.netlify.app/programe_java/java");
