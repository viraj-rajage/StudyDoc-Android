...
public class cpp_program extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpp_program);
        getWindow().setStatusBarColor(ContextCompat.getColor(cpp_program.this, R.color.application_background));
        ...
        notesbackView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(cpp_program.this, Program_activity.class));
            }
        });
        ...
        not_working.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String utl="https://studydocs.netlify.app/programe_cpp/cpp";
        ...
        webview.loadUrl("https://studydocs.netlify.app/programe_cpp/cpp");
